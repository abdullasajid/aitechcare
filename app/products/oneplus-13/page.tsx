        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">OnePlus 13</h1>
              </div>

              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">Product Description</h2>
                <p className="text-muted-foreground leading-relaxed">
                  The OnePlus 13 delivers flagship performance with Snapdragon 8 Elite and a massive 
                  6000mAh battery. Experience Hasselblad-tuned cameras and blazing-fast 100W charging 
                  for unmatched productivity.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  With AI-powered OxygenOS features and IP69 water resistance, the OnePlus 13 combines 
                  premium hardware with intelligent software. The Trinity Engine 2.0 ensures optimal 
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Hasselblad camera with 50MP LYT-808 sensor",
