        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="grid grid-cols-6 gap-2">
                {images.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image}
                      alt={`USB-C Cable 2M view ${index + 1}`}
                      fill
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">USB-C Cable 2M</h1>
              </div>

              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">Product Description</h2>
                <p className="text-muted-foreground leading-relaxed">
                  Premium braided USB-C cable with 100W Power Delivery support. Perfect for charging and 
                  syncing your USB-C devices with superior durability and performance that lasts.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Engineered with premium materials and rigorous testing, this cable delivers reliable 
                  fast charging for MacBook, iPad, and other USB-C devices. The tangle-free design ensures 
